                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                          <div class="li-shipping-inner-box">
                              ...
                              <div class="shipping-text">
                                  ...
                                  <p>Thanh toán bằng các phương thức thanh toán an toàn và phổ biến nhất trên thế giới.
                                  </p>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                          <div class="li-shipping-inner-box">
                              ...
                              <div class="shipping-text">
                                  ...
                                  <p>Bảo vệ người mua của chúng tôi bao gồm việc mua hàng của bạn từ lần nhấp để giao
                                      hàng.</p>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-4 col-md-6">
                          <div class="footer-logo">
                              ...
                              <p class="info">
                                  Chúng tôi chuyên bán các sản phẩm công nghệ
                              </p>
                          </div>
                          <ul class="des">
                              <li>
                                  <span>Địa chỉ: </span>
                                  BKAP-Hoàng Quốc Việt-Bắc Từ Liêm-Hà Nội
                              </li>
                              <li>
                                  <span>Số liên hệ: </span>
                                  <a href="#">(+84) 0984946080</a>
                              </li>
                              <li>
                                  <span>Email: </span>
                                  <a href="mailto://info@yourdomain.com">Haidoit2000@gmail.com</a>
                              </li>
                          </ul>
                      </div>
                      ...
                      <div class="col-lg-4">
                          ...
                          <div><img src="../store_smart/images/dangky.png" alt="" style="width:150px"></div>
