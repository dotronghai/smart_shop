        ...
        <div class="row">
            <div class="col-lg-9 order-1 order-lg-2">
                ...
                <?php 
                                ...
                                $list_product = "SELECT * ,((gia_sp-gia_km)/gia_sp)*100 AS sale FROM tbl_san_pham  WHERE id_dm IN(SELECT id_dm from tbl_dm_sp WHERE id_dm = $cat_id Or parent = $cat_id)";
                                $products = $conn->query($list_product)->fetchAll();
                            ?>
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name"
                                                            href="single-product.php"><?= $pro_l->ten_sp;?></a></h4>
                                                    <div class="price-box">
                                        ...
                                        <div class="col-lg-5 col-md-7">
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="single-product.php">Hummingbird
